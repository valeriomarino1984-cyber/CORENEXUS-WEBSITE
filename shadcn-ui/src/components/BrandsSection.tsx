...
export default function BrandsSection() {
  const brands = [
    { name: 'Zabbix', logo: '/assets/zabbix-logo.png', description: 'Monitoraggio infrastrutture' },
    { name: 'Proxmox', logo: '/assets/proxmox-logo.png', description: 'Virtualizzazione' },
    { name: 'Hikvision', logo: '/assets/hikvision-logo.png', description: 'Videosorveglianza' },
    { name: 'FreePBX', logo: '/assets/freepbx-logo.png', description: 'Centralini VoIP' },
    { name: 'pfSense', logo: '/assets/pfsense-logo.png', description: 'Firewall e routing' },
    { name: 'Cisco', logo: '/assets/cisco-logo.png', description: 'Networking e sicurezza' },
    { name: 'Wazuh', logo: '/assets/wazuh-logo.png', description: 'Security monitoring' },
    { name: 'VMware', logo: '/assets/vmware-logo.png', description: 'Virtualizzazione enterprise' },
    { name: 'Microsoft', logo: '/assets/microsoft-logo.png', description: 'Soluzioni enterprise' },
    { name: 'Azure', logo: '/assets/azure-logo.png', description: 'Cloud computing' },
    { name: 'Red Hat', logo: '/assets/redhat-logo.png', description: 'Enterprise Linux' },
    { name: 'Ubuntu Server', logo: '/assets/ubuntu-server-logo.png', description: 'Server Linux' },
  ];
              ...
              <TiltCard tiltIntensity={6} glareEffect={false}>
                <div className="group relative p-8 rounded-3xl border border-white/10 hover:border-white/20 transition-all duration-500 h-full" style={{ background: '#111827' }}>
                  ...
                  <div className="relative z-10 flex flex-col items-center justify-center space-y-4">
                    {/* Logo container con sfondo scuro uniforme */}
