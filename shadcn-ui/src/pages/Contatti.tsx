...
export default function Contatti() {
  ...
  const localBusinessWithRating = {
    ...
    "review": [
      ...
      },
      {
        ...
        "reviewBody": "Ottima consulenza per la migrazione dei nostri sistemi in cloud. Il team e preparato e ha saputo guidarci passo passo."
      },
      {
        "@type": "Review",
  ...
  return (
    <>
      <SEO
        title="Contatti CoreNexus | Assistenza IT Roma EUR Ostia Fiumicino Pomezia - Tel. 353 401 2055"
        description="Contatta CoreNexus Technology Solution per assistenza informatica a Roma, EUR, Ostia, Fiumicino, Pomezia e tutta Roma Sud. Tel: +39 353 401 2055, Email: info@corenexus.it. Risposta rapida, preventivi gratuiti."
        keywords={[
          ...
          'preventivo gratuito IT Roma',
          'assistenza informatica Roma numero telefono',
        ]}
        canonical="/contatti"
      ...
      <div className="min-h-screen bg-black">
        ...
        {/* Hero Section */}
        <section className="relative overflow-hidden pt-32 pb-10 px-6 premium-gradient">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <MorphingSection>
              <div className="mb-6">
                <Link to="/" className="inline-flex items-center gap-2 text-blue-400 hover:text-blue-300 transition-colors text-sm font-medium">
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
                  Siamo a tua disposizione per consulenze, preventivi e supporto tecnico a Roma, EUR, Ostia, Fiumicino e tutta la zona sud della capitale.
                </p>
                <div className="flex flex-wrap justify-center gap-4 pt-2">
                  <a href="tel:+393534012055" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full glass-effect border border-green-500/30 text-green-400 text-sm font-semibold hover:bg-green-500/10 transition-all">
                    <Phone className="w-4 h-4" />
                    353 401 2055
                  </a>
                  <a href="mailto:info@corenexus.it" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full glass-effect border border-blue-500/30 text-blue-400 text-sm font-semibold hover:bg-blue-500/10 transition-all">
            ...
            <MorphingSection>
              <div className="p-8 rounded-3xl glass-effect border border-white/5">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  <a href="https://www.google.com/maps/place/CoreNexus+Technology+Solution" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-5 rounded-2xl border border-white/5 hover:border-blue-500/30 transition-all duration-300 group hover:bg-white/5">
                  ...
                  <a href="https://www.facebook.com/share/18iUMnHFg7/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-5 rounded-2xl border border-white/5 hover:border-blue-500/30 transition-all duration-300 group hover:bg-white/5">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-gray-400 text-xs mt-0.5">Segui le nostre novita</p>
                    </div>
                    <ExternalLink className="w-4 h-4 text-gray-500 group-hover:text-blue-400 transition-colors shrink-0 ml-auto" />
                  </a>

                  <a href="https://www.linkedin.com/company/corenexus" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-5 rounded-2xl border border-white/5 hover:border-blue-500/30 transition-all duration-300 group hover:bg-white/5">
                ...
                <div className="p-8 rounded-3xl glass-effect border border-white/5 h-full">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center py-2 border-b border-white/5">
                      <span className="text-gray-300">Lunedi - Venerdi</span>
                ...
                <div className="p-8 rounded-3xl glass-effect border border-white/5 h-full">
                  ...
                  <div className="flex flex-wrap gap-2 mt-4">
                    {['Roma EUR', 'Ostia Lido', 'Fiumicino', 'Acilia', 'Mostacciano', 'Pomezia', 'Casal Palocco', 'Infernetto'].map((zona, i) => (
                      <span key={i} className="px-3 py-1.5 rounded-full glass-effect text-gray-300 text-sm border border-white/10">{zona}</span>
                    ))}
                  </div>
                  <div className="mt-6 flex flex-wrap gap-4">
                    <Link to="/dove-siamo" className="text-blue-400 hover:text-blue-300 transition-colors text-sm font-medium inline-flex items-center gap-1">
                      Vedi la mappa completa
                    </Link>
                    <a href="https://www.google.com/maps/place/CoreNexus+Technology+Solution" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 transition-colors text-sm font-medium inline-flex items-center gap-1">
